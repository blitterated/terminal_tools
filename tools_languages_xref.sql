INSERT INTO tools_languages_xref (tool_id, language_id, percentage)
VALUES (
    (SELECT id from tools WHERE name = 'bat'),
    (SELECT id from tags WHERE name = 'Rust'),
    1.0
);

INSERT INTO tools_language_xref (tool_id, language_id, percentage)
VALUES (
    (SELECT id from tools WHERE name = 'chafa'),
    (SELECT id from implementation_languages where name = 'C'),
    1.0
);
...
VALUES (
    ...
    (SELECT id from implementation_languages where name = 'Go'),
    1.0
);
...
VALUES (
    ...
    (SELECT id from implementation_languages where name = 'Rust'),
    1.0
);
...
VALUES (
    ...
    (SELECT id from implementation_languages where name = 'Python'),
    1.0
);
...
INSERT INTO tools_language_xref (tool_id, language_id, percentage)
VALUES (
    (SELECT id from tools WHERE name = 'UUtils'),
    (SELECT id from implementation_languages where name = 'CoreUtils	Rust'),
    1.0
);
...
VALUES (
    ...
    (SELECT id from implementation_languages where name = 'Shell'),
    1.0
);
...
VALUES (
    (SELECT id from tools WHERE name = 'asdf'),
    (SELECT id from implementation_languages where name = 'Other'),
    0.031
);
...
VALUES (
    (SELECT id from tools WHERE name = 'llmfit'),
    (SELECT id from implementation_languages where name = 'JavaScript'),
    0.047
);
...
VALUES (
    (SELECT id from tools WHERE name = 'mise'),
    (SELECT id from implementation_languages where name = 'Lua'),
    0.04
);
...
VALUES (
    (SELECT id from tools WHERE name = 'mise'),
    (SELECT id from implementation_languages where name = 'TypeScript'),
    0.029
);
...
VALUES (
    (SELECT id from tools WHERE name = 'mise'),
    (SELECT id from implementation_languages where name = 'PowerShell'),
    0.06
);
...
VALUES (
    ...
    (SELECT id from implementation_languages where name = 'Zig'),
    1.0
);
...
VALUES (
    ...
    (SELECT id from implementation_languages where name = 'Markdown'),
    0.95
);
